...
const Signup = () => {
  ...
  const onSignup = async () => {
    try {
      ...
      setSignupSuccess(true); // Set success to true
    } catch (error: any) {
      ...
      {signupSuccess ? (
        ...
        <div>
          ...
          <div className="border border-dotted p-5">
            <div>
              <label htmlFor="username" className="flex justify-center mb-4">
                Username
              </label>
              <input
            ...
            <div>
              <label htmlFor="email" className="flex justify-center mb-4">
                Email
              </label>
              <input
                className="p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600 text-black"
            ...
            <div>
              <label htmlFor="password" className="flex justify-center mb-4">
                Password
              </label>
              <input
                className="p-2 border border-gray-300 rounded-lg mb-4 focus:outline-none focus:border-gray-600 text-black"
